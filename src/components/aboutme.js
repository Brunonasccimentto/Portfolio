...
export function AboutMe(){
    return(
        <div id="sobre" className=" bg-slate-300 md:h-[1080px] flex items-center justify-center">
            <div className="flex flex-col lg:flex-row items-center justify-center gap-5 lg:gap-32 bg-slate-900 pt-8 lg:h-auto lg:p-32 lg:w-auto text-slate-300 lg:rounded-tr-[100px] lg:rounded-bl-[100px] lg:rounded-tl-3xl lg:rounded-br-3xl">

            
            <div className=" border-8 flex items-center justify-center border-cyan-300 w-[160px] lg:w-[220px]">
                <img src={me} className=" w-36 h-52 lg:w-52 lg:h-72 -mt-6 -mr-8 mb-3"></img>
            </div>

            <div className=" flex flex-col sobre w-[75%] lg:w-[620px] lg:h-[320px] gap-4 lg:gap-0">
                <h3 className=" text-2xl lg:text-4xl font-semibold lg:mb-10 text-cyan-300"> Sobre mim <span className=" rotate-90">|</span></h3>
                ...
                <div className=" p-6 lg:mt-9 flex justify-center items-center gap-9">
