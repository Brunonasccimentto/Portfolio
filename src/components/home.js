...
export function Home(){
    return(
        ...
        <div id="Inicio" className="flex items-center bg-[url('../images/bg-portfolio.jpg')] h-[720px] w-full lg:h-[1080px] bg-no-repeat bg-cover lg:gap-20 xl:gap-40">
            
            <SideIcons color={"text-cyan-500 lg:text-slate-900"}/>

            <div className=" flex flex-col md:flex-row lg:justify-between w-full lg:gap-[450px]">
                <div className="  sm:text-left xl:text-justify flex flex-col justify-center  lg:flex-shrink-0 lg:w-[600px] ml-[40px] lg:ml-[200px] animate-bounce">
                ...
                <div className="hidden  w-full md:w-[300px] lg:w-[500px] md:flex justify-end items-center animate-slide mb-24 2xl:mr-64 md:flex-grow">
                    <svg className=" w-[400px] h-[560px] lg:w-[600px] lg:h-[760px]" viewBox="-20 -70 200 200" xmlns="http://www.w3.org/2000/svg">
