...
export function Header({menuItens}){
    ...
    return(
    <div className=" bg-slate-900 w-[100%] list-none text-slate-100 flex flex-col lg:flex-row items-center lg:justify-between lg:h-18 2xl:h-20 lg:fixed z-10">
        ...
        <div className="flex flex-row w-full justify-between items-center">
            ...
            return <li key={index} onClick={toggleHeader} className={`list-none hover:brightness-110 cursor-pointer mt-1 lg:mt-0 lg:text-lg 2xl:text-xl hover:text-cyan-300 transition-all duration-500 lg:block`}> 
