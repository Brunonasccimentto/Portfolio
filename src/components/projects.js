    ...
    return(
        ...
        <Dialog.Root>
            <Dialog.Trigger asChild> 
                <img src={image} className=" w-[90%] md:w-80 md:h-52 rounded-md cursor-pointer"></img>    
            </Dialog.Trigger>
            <Dialog.Portal>
                ...
                <a href={`${link}`} target="_blank"> <img src={image} className=" w-[100%] h-[200px] lg:h-[300px] rounded-lg cursor-pointer"></img>  </a> 
