    ...
    return(
            ...
            <div id="skills" className=" bg-slate-300 text-slate-900 flex justify-center items-center">
                <div  className=" skills w-full h-[100%] lg:w-[1620px] lg:h-[650px] flex flex-col lg:flex-row p-9 justify-center rounded-l-[100px]">
                    ...
                    <div className="flex flex-col flex-wrap pt-8 pl-10 h-[420px] lg:h-[100%] w-full lg:w-[55%] gap-8 overflow-auto lg:overflow-hidden scrollbar-thumb-transparent scrollbar-thin scrollbar-track-transparent">
                    ...
                    icon={<SiCypress className="w-7 h-7 lg:w-10 lg:h-10 text-slate-900"/>}/>

                    </div>
                    
                    <div className="skills w-[100%] lg:w-[600px] lg:h-[100%] flex flex-col lg:gap-10 mt-3 bg-slate-900 rounded-3xl p-6 overflow-auto">
