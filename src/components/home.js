        ...
        <div id="Inicio" className="flex items-center bg-[url('../images/bg-portfolio.jpg')] h-[720px] w-full lg:h-screen bg-no-repeat bg-cover lg:gap-40">
            ...
            <div className=" flex flex-col md:flex-row lg:justify-between -mt-[100px] lg:-mt-[0px] w-full">
                <div className=" sm:text-left xl:text-justify flex flex-col justify-center lg:w-[600px] ml-[17%] lg:ml-[200px] animate-bounce">
                    ...
                    <div className="">
                    <h2 className=" text-3xl xxl:text-4xl font-semibold">Olá! Me chamo <span className=" text-cyan-300 text-shadow-sm shadow-black"> Bruno </span></h2>
                ...
                <div className="hidden w-full md:w-[300px] lg:w-[500px] md:flex justify-end items-center animate-slide mb-12">
                    ...
                    <img src={avatar} className=" h-[250px] md:h-[300px] lg:h-[350px] w-[250px] md:w-[300px] lg:w-[350px] lg:-mb-14 lg:mr-24 fixed"></img>
                </div>
            </div>
